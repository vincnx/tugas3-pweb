...
<body>
    <div class="flex items-center justify-center w-full h-screen bg-yellow-300">
        <div class="flex flex-col gap-8 border-4 border-slate-900 rounded-xl w-full max-w-screen-sm p-8 bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0)]">
            <h1 class="text-center text-4xl font-semibold text-slate-900">Halaman Register</h1>
            <form action="controller.php" method="post" class="flex flex-col gap-4">
                <div class="w-full flex flex-col gap-4">
                    <div class="w-full space-y-1">
                        <p class="font-semibold text-slate-900">Email</p>
                        <input type="text" name="email" class="neu-input" required>
                    </div>
                    <div class="w-full space-y-1">
                ...
                <button type="submit" name="register" class="bg-yellow-300 text-slate-900 font-bold neu-button">Daftar</button>
            </form>
            <a href="./newUser.php" class="text-center">Atau Sudah Ada Akun</a>
        </div>
    </div>
</body>
